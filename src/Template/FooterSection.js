                        ...
                        <div className="col-sm-12 col-md-4">
                            <div className="widget-a">
                                <div className="w-header-a">
                                    <h3 className="w-title-a text-brand">SB Vishwakarma</h3>
                                </div>
                                ...
                                <div className="w-footer-a">
                                    <ul className="list-unstyled">
                                        <li className="color-a">
                                            <span className="color-text-a">Phone .</span> sbvishwakarma@gmail
                                        </li>
                                        <li className="color-a">
                                            <span className="color-text-a">Email .</span> +91 8108364637
                                        </li>
                                    </ul>
                                </div>
                            </div>
